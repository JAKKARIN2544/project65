	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="title pb-20">
				<h2 class="h3 mb-0 text-danger" >Dashboard Overview</h2>
			</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-18 text-secondary weight-500" >Customer</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#00eccf"><i class="icon-copy dw dw-user2"></i></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-18 text-secondary weight-500">Employyee</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#ff5b5b"><span class="icon-copy ion-person-stalker"></span></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-18 text-secondary weight-500">food Menu</div>
							</div>
							<div class="widget-icon">
								<div class="icon"data-color="#edff26"><i class="icon-copy dw dw-food-cart" aria-hidden="true"></i></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-18 text-secondary weight-500">Total Sales</div>
							</div>
							<div class="widget-icon">
