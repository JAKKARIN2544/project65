			...
			<div class="sidebar-menu">
				...
				<li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="../Back End/user.php">List User</a></li>
						</ul>
						<ul class="submenu">
							<li><a href="../Back End/add_user.php">Add User</a></li>
						</ul>
					</li>

					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-group"></span><span class="mtext">Employyee</span>
						</a>
						<ul class="submenu">
							<li><a href="../Back End/employee.php">List Employyee</a></li>
						</ul>
						<ul class="submenu">
							<li><a href="basic-table.html">Add Employyee</a></li>
						</ul>
					</li>
					<li>
						<a href="../Back End/product.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-muffin"></span><span class="mtext">Food Menu</span>
						</a>
					</li>
					<li>
						<a href="../Back End/food_ingredients.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-burger"></span><span class="mtext">Food ingredients</span>
						</a>
					</li>
				</ul>
			</div>
